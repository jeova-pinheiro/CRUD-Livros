...
class StoreLivroRequest extends FormRequest
{
    ...
    /**
     * Manipula falha de validação e retorna JSON com os erros.
     *
    ...
    /**
     * Regras de validação para o cadastro de livros.
     *
     * @return array
     */
    ...
    {
        return [
            'LIV_TITULO'          => 'required|string|max:255',
            'LIV_AUTOR'           => 'required|string|max:255',
            'LIV_ANO_PUBLICACAO' => 'required|integer|min:1|max:' . date('Y'),
            'LIV_GENERO'          => 'nullable|string|max:255',
        ];
    }
